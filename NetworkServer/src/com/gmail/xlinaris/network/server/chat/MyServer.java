...
import com.gmail.xlinaris.network.server.chat.auth.AuthWithDataBase;
...
public class MyServer {
    ...
    public MyServer(int port) throws IOException {
        ...
        //this.authService = new BaseAuthService(); //это была базовая аутентификация
        this.authService=new AuthWithDataBase(); //аутентификация с ипользованием сервиса базы данных
    }
